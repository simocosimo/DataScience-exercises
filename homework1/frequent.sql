...
WHERE S.TIME_ID = T.TIME_ID AND T.DATEYEAR = 2021 AND S.MUSEUM_ID = M.MUSEUM_ID
...
MUSEUM(MUSEUM_ID, CATEGORY, CITY, PROV, REGION, WIFI, CAFÈ, AUDIO_GUIDES, ...) --listing all services